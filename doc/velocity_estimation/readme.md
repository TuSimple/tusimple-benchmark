...
<img src="https://latex.codecogs.com/gif.latex?E_{vtotal}&space;=&space;\frac{E_{vfar}&plus;E_{vmed}&plus;E_{vnear}}{3}" title="E_{vtotal} = \frac{E_{vfar}+E_{vmed}+E_{vnear}}{3}" />
